...
class VisitControllerTest {
    ...
    @Test
    void loadPetWithVisitWithStubbibing() {
        // given
        Map<String, Object> model = new HashMap<>();
        Pet pet = new Pet(12l);
        Pet pet3 = new Pet(3l);
        ...
        assertThat(visit).isNotNull();
        assertThat(visit.getPet()).isNotNull();
        assertThat(visit.getPet().getId()).isNotEqualTo(12l); // we can't load pet with id 12 because we are overriding real method, instead of calling it
        verify(petService, times(1)).findById(anyLong());
    }
}